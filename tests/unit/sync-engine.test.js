...
describe('SyncEngine Unit Tests', () => {
  ...
  describe('verifySyncStatus', () => {
    ...
    test('should handle empty graph', async () => {
      const fileTasks = [{ id: 'task-1', updated_at: '2025-06-11T12:00:00Z' }];
  ...
  describe('updateTaskInGraph', () => {
    test('should update task fields', async () => {
      ...
      expect(mockGraphConnection.updateTask).toHaveBeenCalledWith('test-123', {
        title: 'Updated Title',
        description: 'Updated description',
        status: 'done',
        priority: 'low',
